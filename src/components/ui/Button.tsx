...
const SIZE_CONFIG: Record<ButtonSize, { height: number; paddingHorizontal: number; textStyle: TextStyle }> = {
  sm: { height: 36, paddingHorizontal: Spacing.lg, textStyle: Typography.footnote },
  md: { height: 48, paddingHorizontal: Spacing.xl, textStyle: Typography.headline },
  lg: { height: 56, paddingHorizontal: Spacing.xxl, textStyle: Typography.headline },
};
